...
contacts.txt One name per line Contact names (emails:
name@pawnee.in.gov)
...
Edit the .txt files (one entry per line, blank lines ignored) and
theme.json to change the demo theme. Run make build-demo to regenerate.
